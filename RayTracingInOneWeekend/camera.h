...
private:
    ...
    void initialize() {
        ...
        //Calculate the u,v,w unit basis vectors for camera cordinate frame
    ...
    point3 defocus_disk_sample() const  {
        //returns a random point in defocus disc
        auto p = random_in_unit_disk();
        return center + (p[0] * defocus_disk_u) + (p[1] * defocus_disk_v); //0 and 1 to get x and y component only of random unit vector
    }
